...
<div class="layui-container">
    ...
    <div class="search-form">
        <form class="layui-form" action="<?php echo U('index');?>" method="get">
    ...
    <div><a href="<?php echo U('add');?>" class="layui-btn">新增</a></div>

    <table class="layui-table" lay-data="{url:'<?php echo U("ajaxIndex",$param);?>', page:true, id:'data_table'}" lay-filter="data_table">
        <thead>
        <tr>
    ...
    layui.use(['form', 'table', 'laydate'], function(){
        ...
        table.on('tool(data_table)', function(obj){
            ...
            if(obj.event === 'detail'){
                ...
                location.href="<?php echo U('add');?>?id="+data.contract_id;
                //layer.alert('编辑行：<br>'+ JSON.stringify(data))
            } else if(obj.event === 'expect'){ // 应收
                location.href="<?php echo U('expect_receipt');?>?contract_id="+data.contract_id;
                ...
                location.href="<?php echo U('duty');?>?contract_id="+data.contract_id;
